...
local module = SUI:NewModule('Style_Blizzard')
...
local Defaults = {
	...
	BartenderProfile = 'SpartanUI - Blizzard',
	BartenderSettings = {
		ActionBars = {
			actionbars = {
				{
					...
					position = {
						point = 'CENTER',
						parent = 'Blizzard_ActionBarPlate',
						x = -510,
						y = 36,
						scale = 0.85,
				...
				}, -- 6
				{
					...
					padding = 3,
					skin = {Zoom = true},
					position = {parent = 'Blizzard_ActionBarPlate', scale = 0.85, growHorizontal = 'RIGHT'}
				}, -- 7
				{
					enabled = false,
					buttons = 12,
		...
		MultiCast = {
			...
			fadeout = true,
			enabled = true,
			position = {point = 'TOPRIGHT', parent = 'Blizzard_ActionBarPlate', x = -777, y = -4, scale = 0.75}
		},
		Vehicle = {
			fadeoutalpha = .6,
			version = 3,
			...
			enabled = false,
			padding = 3,
			position = {point = 'CENTER', parent = 'Blizzard_ActionBarPlate', x = -15, y = 213, scale = 0.85}
		},
		ExtraActionBar = {
			fadeoutalpha = .6,
			version = 3,
			fadeout = true,
			enabled = true,
			position = {point = 'CENTER', parent = 'Blizzard_ActionBarPlate', x = -32, y = 240}
		},
...
if not SUI.DB.Styles.Blizzard.Artwork then
	SUI.DB.Styles.Blizzard = SUI:MergeData(SUI.DB.Styles.Blizzard, Defaults, true)
else
	SUI.DB.Styles.Blizzard = SUI:MergeData(SUI.DB.Styles.Blizzard, Defaults, false)
end
SUI.DB.Styles.Blizzard.BartenderSettings = Defaults.BartenderSettings
