	...
	SUI.opt.args['General'].args['font'] = {
		...
		args = {
			...
			c = {
				...
				get = function(info)
					return SUI.DB.font.Primary.Type
				end,
				set = function(info, val)
					SUI.DB.font.Primary.Type = val
				end
			},
			d = {
				name = L['AdjFontSize'],
				...
				step = 1,
				get = function(info)
					return SUI.DB.font.Primary.Size
				end,
				set = function(info, val)
					SUI.DB.font.Primary.Size = val
				end
			},
			z = {
			...
			Player = {
				...
				args = {
					...
					PlOutline = {
						...
						get = function(info)
							return SUI.DB.font.Player.Type
						end,
						set = function(info, val)
					...
					PlSize = {
						...
						step = 1,
						get = function(info)
							return SUI.DB.font.Player.Size
						end,
						set = function(info, val)
